...
BondStyle(langevin,BondLANGEVIN)

#else

#ifndef LMP_BOND_LANGEVIN_H
#define LMP_BOND_LANGEVIN_H
...
class BondLANGEVIN : public Bond {
 public:
  BondLANGEVIN(class LAMMPS *);
  virtual ~BondLANGEVIN();
